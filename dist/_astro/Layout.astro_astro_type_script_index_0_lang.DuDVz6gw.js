...
`,
  Lr = () => {
    ...
    (o.type = "text/css"), (o.innerText = Br), document.head.appendChild(o);
  },
  me = (o, t, e, i) => (o - t - e / 2) / i,
  st = {
  ...
  ht = (o, t) => {
    const e = o.getAttribute(st?.dataAttr);
    return !!(e && e.includes(t));
  },
  Ir = (o) => getComputedStyle(document.documentElement).getPropertyValue(o);
function yt(o) {
  if (o === void 0)
 ...
 */ var rt = {
  ...
  ui = "",
    ...
    var e = t[0],
      i,
      r;
    if ((gt(e) || L(e) || (t = [t]), !(i = (e._gsap || {}).harness))) {
      for (r = ve.length; r-- && !ve[r].targetTest(e); );
      i = ve[r];
    }
    for (r = t.length; r--; )
      (t[r] && (t[r]._gsap || (t[r]._gsap = new pr(t[r], i)))) ||
        t.splice(r, 1);
    return t;
  },
  Bt = function (t) {
    return t._gsap || fi(ut(t))[0]._gsap;
  },
  Gi = function (t, e, i) {
    return (i = t[e]) && L(i)
      ? t[e]()
  ...
  Hi = function (t) {
    var e = parseFloat(t);
    return (e || e === 0) && (t + "").match(Yi).length < 2
      ? e
      : X(t)
        ? t.trim()
        : t;
  ...
  se = function (t) {
    var e = t.parent || F,
      i = t.keyframes ? $r($(t.keyframes)) : ft;
    if (K(t.inherit))
  ...
  ct = function (t, e, i, r) {
    return (
      e.parent && Ct(e),
      (e._start = U(
        (vt(i) ? i : i || t !== F ? at(t, i, e) : t._time) + e._delay
      )),
      (e._end = U(
  ...
  ji = function (t, e) {
    return (
      (nt.ScrollTrigger || ai("scrollTrigger", e)) &&
  ...
  jr = function (t, e, i, r) {
    ...
    if (
      ...
      if (!t._initted && Ji(t, e, r, i, f)) return;
      for (
        _ = t._zTime,
          t._zTime = e || (i ? A : 0),
          i || (i = e && !_),
      ...
      e < 0 && We(t, e, i, !0),
        ...
        f && t._repeat && !i && t.parent && it(t, "onRepeat"),
        (e >= t._tDur || e < 0) &&
          t.ratio === s &&
          (s && Ct(t, 1),
          !i &&
  ...
  wi = function (t) {
    return t instanceof H ? Lt(t) : Zt(t, t._dur);
  },
  tn = { _start: 0, endTime: fe, totalDuration: fe },
  at = function o(t, e, i) {
    var r = t.labels,
      n = t._recent || tn,
    ...
    return X(e) && (isNaN(e) || e in r)
      ? ((f = e.charAt(0)),
        ...
        f === "<" || f === ">"
          ...
          : a < 0
            ? (e in r || (r[e] = s), r[e])
            : ((f = parseFloat(e.charAt(a - 1) + e.substr(a + 1))),
              u && i && (f = (f / 100) * ($(i) ? i[0] : i).totalDuration()),
              a > 1 ? o(t, e.substr(0, a - 1), i) + f : s + f))
      : e == null
        ? s
        : +e;
  },
  ae = function (t, e, i) {
    ...
    if ((r && (s.duration = e[1]), (s.parent = i), t)) {
      for (a = s, f = i; f && !("immediateRender" in a); )
        (a = f.vars.defaults || {}), (f = K(f.vars.inherit) && f.parent);
      ...
      function (c, d, p) {
        ...
        if (!g) {
          if (((b = e.grid === "auto" ? 0 : (e.grid || [1, ot])[1]), !b)) {
            for (
              P = -ot;
              P < (P = p[b++].getBoundingClientRect().left) && b < h;
          ...
          for (
            g = s[h] = [],
              y = f ? Math.min(b, h) * l - 0.5 : r % b,
              x = b === ot ? 0 : f ? (h * _) / b - 0.5 : (r / b) | 0,
              P = 0,
              S = ot,
              w = 0;
            w < h;
            ...
            (v = (w % b) - y),
              (T = x - ((w / b) | 0)),
              (g[w] = m = u ? Math.abs(u === "y" ? T : v) : Li(v * v + T * T)),
              m > P && (P = m),
              m < S && (S = m);
          r === "random" && er(g),
            (g.max = P - S),
            ...
            (g.v = h =
              (parseFloat(e.amount) ||
                ...
                0) * (r === "edges" ? -1 : 1)),
            (g.b = h < 0 ? n - h : n),
            (g.u = W(e.amount || e.each) || 0),
            (i = i && h < 0 ? _r(i) : i);
        }
        return (
          (h = (g[c] - g.min) / g.max || 0), U(g.b + (i ? i(h) : h) * g.v) + g.u
        );
      }
    );
  },
  ...
  le = function (t) {
    for (var e = 0, i = "", r, n, s, a; ~(r = t.indexOf("random(", e)); )
      (s = t.indexOf(")", r)),
        (a = t.charAt(r + 7) === "["),
        (n = t.substr(r + 7, s - r - 7).match(a ? Yi : Ue)),
        (i +=
          t.substr(e, r - e) + nr(a ? n : +n[0], a ? 0 : +n[1], +n[2] || 1e-5)),
        (e = s + 1);
  ...
  ar = function (t, e, i, r, n) {
    var s = e - t,
      a = r - i;
    return Mt(n, function (f) {
      return i + (((f - t) / s) * a || 0);
    });
  },
  fn = function o(t, e, i, r) {
    var n = isNaN(t + e)
      ? 0
      : function (d) {
          return (1 - d) * t + d * e;
    ...
    if (!n) {
      ...
      if (!l) {
        for (f in e) li.call(a, t, f, "get", e[f]);
        n = function (p) {
  ...
  Pi = function (t, e, i) {
    ...
    for (s in r)
      (a = r[s] - e),
        a < 0 == !!i && a && n > (a = Math.abs(a)) && ((f = s), (n = a));
    return f;
  },
  it = function (t, e, i) {
    var r = t.vars,
  ...
  fr = function (t, e, i) {
    var r = t ? (vt(t) ? [t >> 16, (t >> 8) & M, t & M] : 0) : ne.black,
      n,
      s,
      a,
      f,
    ...
    if (!r) {
      ...
      } else r = t.match(Ue) || ne.transparent;
      r = r.map(Number);
    }
    return (
      e &&
  ...
  Si = function (t, e, i) {
    ...
    if (
      ...
      i && ((l = lr(t)), (f = i.c), f.join(r) !== l.c.join(r)))
    )
      for (u = t.replace(Ot, "1").split(qt), _ = u.length - 1; a < _; a++)
        r +=
          u[a] +
          (~f.indexOf(a)
            ? n.shift() || s + "0,0,0,0)"
    ...
    if (!u)
      for (u = t.split(Ot), _ = u.length - 1; a < _; a++) r += u[a] + n[a];
    return r + u[_];
  },
  Ot = (function () {
    var o =
    ...
    var o = Date.now,
      ...
      p = function h(g) {
        ...
        if (
          ...
          for (d = 0; d < a.length; d++) a[d](m, c, w, g);
      };
    return (
      (_ = {
        time: 0,
        ...
        wake: function () {
          Ui &&
            (!Xe &&
              ...
              Xi(be || _t.GreenSockGlobals || (!_t.gsap && _t) || {}),
              or.forEach(ur)),
        ...
        sleep: function () {
          (l ? cancelAnimationFrame : clearTimeout)(f), (he = 0), (u = fe);
        },
        ...
        add: function (g, y, x) {
          var v = y
            ? function (T, m, w, P) {
                g(T, m, w, P), _.remove(v);
              }
            : g;
          return _.remove(g), a[x ? "unshift" : "push"](v), jt(), v;
        },
        remove: function (g, y) {
  ...
  cn = function (t) {
    for (
      ...
      (f = i[n]),
        (a = n !== s - 1 ? f.lastIndexOf(",") : f.length),
        (u = f.substr(0, a)),
        (e[r] = isNaN(u) ? u.replace(_n, "").trim() : +u),
        (r = f.substr(a + 1).trim());
    return e;
  },
  dn = function (t) {
  ...
  pn = function (t) {
    ...
    return i && e.length > 1 && i.config
      ? i.config.apply(
          null,
          ~t.indexOf("{") ? [cn(e[1])] : dn(t).split(",").map(Hi)
        )
      : O._CE && hn.test(t)
        ? O._CE("", t)
        : i;
  ...
  Fe = function o(t, e, i) {
    var r = e >= 1 ? e : 1,
      ...
      s = (n / Ye) * (Math.asin(1 / r) || 0),
      a = function (l) {
        return l === 1 ? 1 : r * Math.pow(2, -10 * l) * Ur((l - s) * n) + 1;
      },
      f =
        t === "out"
          ? a
  ...
  _e = (function () {
    ...
    return (
      ...
      (t.timeScale = function (i, r) {
        ...
        var n =
          this.parent && this._ts ? Se(this.parent._time, this) : this._tTime;
        return (
          (this._rts = +i || 0),
      ...
      (t.startTime = function (i) {
        if (arguments.length) {
          ...
          return (
            r && (r._sort || !this.parent) && ct(r, this, i - this._delay), this
          );
        }
        return this._start;
      }),
...
var H = (function (o) {
  ...
  function t(i, r) {
    ...
    return (
      ...
      F && ct(i.parent || F, yt(n), r),
      i.reversed && n.reverse(),
      i.paused && n.paused(!0),
      i.scrollTrigger && ji(yt(n), i.scrollTrigger),
      n
    );
  }
  var e = t.prototype;
  return (
    ...
    (e.set = function (r, n, s) {
      return (
        ...
        new k(r, n, at(this, s), 1),
        this
      );
    }),
    (e.call = function (r, n, s) {
      return ct(this, k.delayedCall(0, r, n), s);
    }),
    (e.staggerTo = function (r, n, s, a, f, u, l) {
      return (
        (s.duration = n),
    ...
    (e.staggerFrom = function (r, n, s, a, f, u, l) {
      return (
        (s.runBackwards = 1),
        (se(s).immediateRender = K(s.immediateRender)),
        this.staggerTo(r, n, s, a, f, u, l)
      );
    }),
    (e.staggerFromTo = function (r, n, s, a, f, u, l, _) {
      return (
        (a.startAt = s),
        (se(a).immediateRender = K(a.immediateRender)),
        this.staggerTo(r, n, a, f, u, l, _)
      );
    }),
    (e.render = function (r, n, s) {
      var a = this._time,
        ...
        u = this._dur,
        l = r <= 0 ? 0 : U(r),
        _ = this._zTime < 0 != r < 0 && (this._initted || !u),
        c,
        d,
        p,
        h,
        ...
        P;
      if (
        (this !== F && l > f && r >= 0 && (l = f), l !== this._tTime || s || _)
      ) {
        if (
          (a !== this._time &&
            u &&
          ...
          (v = this._ts),
          (y = !v),
          _ && (u || (a = this._zTime), (r || !n) && (this._zTime = r)),
          this._repeat)
        ) {
          if (
            ((w = this._yoyo),
          ...
          if (
            ...
            if (
              ...
              (a = S ? 0 : l % u ? u : l),
              (this._lock = 1),
              (this.render(a || (P ? 0 : U(h * g)), n, !u)._lock = 0),
              (this._tTime = l),
        ...
        if (
          (this._hasPause &&
            !this._forcing &&
            this._lock < 2 &&
            ((x = Jr(this, U(a), U(c))), x && (l -= c - (c = x._start))),
          (this._tTime = l),
          (this._time = c),
          (this._act = !v),
          this._initted ||
            ...
            (this._zTime = r),
            (a = 0)),
          !a && c && !n && !h && (it(this, "onStart"), this._tTime !== l))
        )
          return this;
        if (c >= a && r >= 0)
          for (d = this._first; d; ) {
        ...
        if (
          ...
          return (this._start = T), Re(this), this.render(r, n, s);
        this._onUpdate && !n && it(this, "onUpdate", !0),
          ((l === f && this._tTime >= this.totalDuration()) || (!l && a)) &&
            (T === this._start || Math.abs(v) !== Math.abs(this._ts)) &&
            (this._lock ||
              ((r || !u) &&
                ((l === f && this._ts > 0) || (!l && this._ts < 0)) &&
                Ct(this, 1),
              !n &&
                !(r < 0 && !a) &&
                (l || a || !f) &&
                (it(
                  this,
                  l === f && r >= 0 ? "onComplete" : "onReverseComplete",
                  !0
                ),
                this._prom &&
                  !(l < f && this.timeScale() > 0) &&
                  this._prom())));
      }
      return this;
    }),
    ...
    (e.addPause = function (r, n, s) {
      var a = k.delayedCall(0, n || fe, s);
      return (
        (a.data = "isPause"), (this._hasPause = 1), ct(this, a, at(this, r))
      );
    }),
    ...
    (e.killTweensOf = function (r, n, s) {
      for (var a = this.getTweensOf(r, s), f = a.length; f--; )
        bt !== a[f] && a[f].kill(r, n);
      return this;
    }),
    (e.getTweensOf = function (r, n) {
      for (var s = [], a = ut(r), f = this._first, u = vt(n), l; f; )
        f instanceof k
          ? Gr(f._targets, a) &&
            (u
              ? (!bt || (f._initted && f._ts)) &&
              ...
              : !n || f.isActive()) &&
            s.push(f)
          : (l = f.getTweensOf(a, n)).length && s.push.apply(s, l),
          (f = f._next);
      return s;
    }),
          ...
          ft(
            {
              ...
              onStart: function () {
                if ((s.pause(), !d)) {
                  ...
                  p._dur !== g && Zt(p, g, 0, 1).render(p._time, !0, !0),
                    (d = 1);
                }
                l && l.apply(p, _ || []);
              },
    ...
    (e.shiftChildren = function (r, n, s) {
      s === void 0 && (s = 0);
      for (var a = this._first, f = this.labels, u; a; )
      ...
      if (s._dirty) {
        for (_ = s.parent; a; )
          (u = a._prev),
            ...
            (a = u);
        Zt(s, s === F && s._time > n ? s._time : n, 1, 1), (s._dirty = 0);
      }
      return s._tDur;
    }),
    (t.updateRoot = function (r) {
      if ((F._ts && ($i(F, Se(r, F)), (Wi = et.frame)), et.frame >= vi)) {
        vi += rt.autoSleep || 120;
        var n = F._first;
...
var gn = function (t, e, i, r, n, s, a) {
    var f = new Z(this._pt, t, e, 0, 1, Tr, null, n),
      u = 0,
      l = 0,
      _,
      c,
    ...
    for (
      ...
      (p = _[0]),
        (h = r.substring(u, _.index)),
        d ? (d = (d + 1) % 5) : h.substr(-5) === "rgba(" && (d = 1),
        p !== c[l++] &&
          ((g = parseFloat(c[l - 1]) || 0),
          (f._pt = {
            _next: f._pt,
            p: h || l === 1 ? h : ",",
            s: g,
            c: p.charAt(1) === "=" ? Gt(g, p) - g : parseFloat(p) - g,
  ...
  li = function (t, e, i, r, n, s, a, f, u, l) {
    L(r) && (r = r(n || 0, t, s));
    var _ = t[e],
      c =
        i !== "get"
    ...
    if (
      ...
      return !isNaN(c * r) && r !== ""
        ? ((p = new Z(
          ...
          (this._pt = p))
        : (!_ && !(e in t) && ai(e, r),
          gn.call(this, t, e, c, r, d, f || rt.stringFilter, u));
  },
  mn = function (t, e, i, r, n) {
    if (
      (L(t) && (t = oe(t, n, e, i, r)),
      !gt(t) || (t.style && t.nodeType) || $(t) || Ii(t))
    )
  ...
  gr = function (t, e, i, r, n, s) {
    ...
    if (
      ...
      (a = new tt[t]()).init(
        n,
        a.rawVars ? e[t] : mn(e[t], r, n, s, i),
        i,
        r,
        s
      ) !== !1 &&
      ((i._pt = f = new Z(i._pt, n, t, 0, 1, a.render, a, 0, a.priority)),
      i !== Wt)
    )
  ...
  hi = function o(t, e, i) {
    var r = t.vars,
      ...
      g = t._targets,
      y = t.parent,
      x = y && y.data === "nested" ? y.vars.targets : g,
      v = t._overwrite === "auto" && !ii,
      T = t.timeline,
      m,
      w,
      P,
    ...
    if (
      (T && (!c || !n) && (n = "none"),
      (t._ease = It(n, Kt.ease)),
      (t._yEase = _ ? _r(It(_ === !0 ? n : _, Kt.ease)) : 0),
      _ &&
        t._yoyo &&
        !t._repeat &&
      ...
      if (
        ((R = g[0] ? Bt(g[0]).harness : 0),
        (N = R && r[R.prop]),
        (m = Pe(r, oi)),
        h &&
          (h._zTime < 0 && h.progress(1),
          e < 0 && l && a && !d ? h.render(-1, !0) : h.revert(l && p ? xe : qr),
          (h._lazy = 0)),
        s)
      ) {
        if (
          ...
          (t._startAt._dp = 0),
          (t._startAt._sat = t),
          e < 0 && (G || (!a && !d)) && t._startAt.revert(xe),
          a && p && e <= 0 && i <= 0)
        ) {
          e && (t._zTime = e);
          return;
        ...
        if (
          ...
          N && (P[R.prop] = N),
          Ct((t._startAt = k.set(g, P))),
          (t._startAt._dp = 0),
          (t._startAt._sat = t),
          e < 0 && (G ? t._startAt.revert(xe) : t._startAt.render(-1, !0)),
          (t._zTime = e),
          !a)
        )
          o(t._startAt, A, A);
      ...
      for (
        t._pt = t._ptCache = 0, f = (p && K(f)) || (f && !p), w = 0;
        w < g.length;
        w++
      ) {
        if (
          ((b = g[w]),
          (E = b._gsap || fi(g)[w]._gsap),
          (t._ptLookup[w] = q = {}),
          qe[E.id] && St.length && we(),
          (V = x === g ? w : x.indexOf(b)),
          R &&
            (D = new R()).init(b, N || m, t, V, x) !== !1 &&
            ((t._pt = S =
              new Z(t._pt, b, D.name, 0, 1, D.render, D, 0, D.priority)),
            D._props.forEach(function (lt) {
              q[lt] = S;
            }),
            D.priority && (C = 1)),
          !R || N)
          ...
          for (P in m)
            tt[P] && (D = gr(P, m, t, V, b, x))
              ? D.priority && (C = 1)
              : (q[P] = S =
                  li.call(t, b, P, "get", m[P], V, x, 0, r.stringFilter));
        t._op && t._op[w] && t.kill(b, t._op[w]),
          v &&
            t._pt &&
            ((bt = t),
            F.killTweensOf(b, q, t.globalTime(e)),
            (Y = !t.parent),
            (bt = 0)),
          t._pt && f && (qe[E.id] = 1);
      }
      C && br(t), t._onInit && t._onInit(t);
    }
    (t._onUpdate = u),
      (t._initted = (!t._op || t._pt) && !Y),
      c && e <= 0 && T.render(ot, !0, !0);
  },
  yn = function (t, e, i, r, n, s, a, f) {
      ...
      for (
        ...
        if (!l)
          return (
            ...
            hi(t, a),
            (Qe = 0),
            f ? ue(e + " not eligible for reset") : 1
          );
        u.push(l);
      }
    for (d = u.length; d--; )
  ...
  xn = function (t, e) {
    ...
    n = Vt({}, e);
    for (s in r)
      if (s in n) for (f = r[s].split(","), a = f.length; a--; ) n[f[a]] = n[s];
    return n;
  },
  vn = function (t, e, i, r) {
    ...
    if ($(e))
      (a = i[t] || (i[t] = [])),
        e.forEach(function (f, u) {
          return a.push({ t: (u / (e.length - 1)) * 100, v: f, e: n });
        });
    else
      for (s in e)
        (a = i[s] || (i[s] = [])),
  ...
  mr = ui + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",
  yr = {};
...
var k = (function (o) {
  ...
  function t(i, r, n, s) {
    ...
    var f = a.vars,
      ...
      y = f.yoyoEase,
      x = r.parent || F,
      v = ($(i) || Ii(i) ? vt(i[0]) : "length" in r) ? [i] : ut(i),
      T,
      m,
      w,
      P,
    ...
    if (
      ...
      if (
        ...
        if (((P = v.length), (C = c && ir(c)), gt(c)))
          for (S in c) ~mr.indexOf(S) && (E || (E = {}), (E[S] = c[S]));
        for (m = 0; m < P; m++)
          (w = Pe(r, yr)),
            (w.stagger = 0),
            y && (w.yoyoEase = y),
            E && Vt(w, E),
            (b = v[m]),
            (w.duration = +oe(u, yt(a), m, b, v)),
            (w.delay = (+oe(l, yt(a), m, b, v) || 0) - a._delay),
            !c &&
              P === 1 &&
              w.delay &&
              ((a._delay = l = w.delay), (a._start += l), (w.delay = 0)),
            T.to(b, w, C ? C(m, b, v) : 0),
            (T._ease = O.none);
        T.duration() ? (u = l = 0) : (a.timeline = 0);
      } else if (p) {
        se(ft(T.vars.defaults, { ease: "none" })),
        ...
        if ($(p))
          ...
          w = {};
          for (S in p)
            S === "ease" || S === "easeEach" || vn(S, p[S], w, p.easeEach);
          for (S in w)
            for (
              D = w[S].sort(function (N, Y) {
                return N.t - Y.t;
              }),
                R = 0,
                m = 0;
              ...
              (q = D[m]),
                (V = {
                  ease: q.e,
                  duration: ((q.t - (m ? D[m - 1].t : 0)) / 100) * u,
                }),
                (V[S] = q.v),
                T.to(v, V, R),
                (R += V.duration);
    ...
    return (
      d === !0 && !ii && ((bt = yt(a)), F.killTweensOf(v), (bt = 0)),
      ct(x, yt(a), n),
      ...
      (_ ||
        (!u &&
          ...
          Qr(yt(a)) &&
          x.data !== "nested")) &&
        ((a._tTime = -A), a.render(Math.max(0, -l) || 0)),
      g && ji(yt(a), g),
      a
    );
  }
  ...
  return (
      ...
      if (!u) jr(this, r, n, s);
        ...
        if (((c = _), (v = this.timeline), this._repeat)) {
          ...
          if (
            ...
            (g = Qt(this._tTime, h)),
            c === a && !s && this._initted && p === g)
          )
            return (this._tTime = _), this;
          p !== g &&
            (v && this._yEase && cr(v, y),
            this.vars.repeatRefresh &&
              ...
              this._initted &&
              ((this._lock = s = 1),
              (this.render(U(h * p), !0).invalidate()._lock = 0)));
        }
        if (!this._initted) {
          if (Ji(this, l ? r : c, s, n, _)) return (this._tTime = 0), this;
        ...
        if (
          ...
          c && !a && !n && !p && (it(this, "onStart"), this._tTime !== _))
        )
          return this;
        ...
        (v && v.render(r < 0 ? r : v._dur * v._ease(c / this._dur), n, s)) ||
          ...
          this._onUpdate &&
            !n &&
            (l && We(this, r, n, s), it(this, "onUpdate")),
          this._repeat &&
            p !== g &&
            this.vars.onRepeat &&
            !n &&
          ...
          (_ === this._tDur || !_) &&
            this._tTime === _ &&
            (l && !this._onUpdate && We(this, r, !0, !0),
            (r || !u) &&
            ...
            !n &&
              !(l && !a) &&
              (_ || a || y) &&
              (it(this, _ === f ? "onComplete" : "onReverseComplete", !0),
    ...
    (e.resetTo = function (r, n, s, a, f) {
      he || et.wake(), this._ts || this.play();
      var u = Math.min(this._dur, (this._dp._time - this._start) * this._ts),
        l;
      return (
        this._initted || hi(this, u),
        (l = this._ease(u / this._dur)),
        yn(this, r, n, s, a, l, u, f)
    ...
    (e.kill = function (r, n) {
      ...
      if (this.timeline) {
        ...
        return (
          this.timeline.killTweensOf(r, n, bt && bt.vars.overwrite !== !0)
            ._first || re(this),
          this.parent &&
      ...
      for (
        ...
        if (~f.indexOf(a[y])) {
          ...
          for (h in p)
            (g = c && c[h]),
              g &&
                ((!("kill" in g.d) || g.d.kill(h) === !0) && Me(this, g, "_pt"),
                delete c[h]),
              d !== "all" && (d[h] = 1);
        }
...
ft(k.prototype, { _targets: [], _lazy: 0, _startAt: 0, _op: 0, _onInit: 0 });
...
var _i = function (t, e, i) {
  ...
  ci = function (t, e) {
    return L(t[e]) ? xr : ri(t[e]) && t.setAttribute ? bn : _i;
  },
  vr = function (t, e) {
...
nt.TweenMax = nt.TweenLite = k;
nt.TimelineLite = nt.TimelineMax = H;
F = new H({
  sortChildren: !1,
  defaults: Kt,
...
var Nt = [],
    ...
    return (
      ...
      (t.kill = function (i, r) {
        ...
        if (
          (i
            ? (function () {
                for (var a = n.getTweens(), f = n.data.length, u; f--; )
                  (u = n.data[f]),
                    u.data === "isFlip" &&
                      (u.revert(),
                ...
                for (
                  ...
                  (u = n.data[f]),
                    u instanceof H
                      ...
                      : !(u instanceof k) && u.revert && u.revert(i);
  ...
  Oe = {
      ...
      return (
        ...
        t &&
          (e
            ...
            : function (a, f, u) {
                return s(((tt[a] && tt[a].get) || n)(t, a, f, u));
              })
      );
    },
    quickSetter: function (t, e, i) {
      ...
      var s = tt[e],
        a = Bt(t),
        f = (a.harness && (a.harness.aliases || {})[e]) || e,
        u = s
          ? function (l) {
              var _ = new s();
              (Wt._pt = 0),
    ...
    defaults: function (t) {
      return t && t.ease && (t.ease = It(t.ease, Kt.ease)), Ti(Kt, t || {});
    },
    config: function (t) {
      return Ti(rt, t || {});
    },
    registerEffect: function (t) {
      ...
      (r || "").split(",").forEach(function (a) {
        return (
          a && !tt[a] && !nt[a] && ue(e + " effect requires " + a + " plugin.")
        );
      }),
        (Ee[e] = function (a, f, u) {
          return i(ut(a), ft(f || {}, n), u);
        }),
        s &&
          (H.prototype[e] = function (a, f, u) {
            return this.add(Ee[e](a, gt(f) ? f : (u = f) && {}, this), u);
          });
    },
...
k.version = H.version = J.version = "3.12.5";
Ui = 1;
ni() && jt();
O.Power0;
O.Power1;
 ...
 */ var Ci,
  ...
  Cr = function (t, e) {
    var i = { target: t, props: [], revert: Wn, save: qn };
    return (
  ...
  Mr = function (t) {
    ...
    return (
      (e && (e.width || e.height)) || t.getBBox === Ne || (e = Ne.call(t, !0)),
      e && !e.width && !e.x && !e.y
        ? {
            x: +Di(t, ["x", "cx", "x1"]) || 0,
            y: +Di(t, ["y", "cy", "y1"]) || 0,
  ...
  kt = function o(t, e, i, r) {
    var n = parseFloat(i) || 0,
      ...
      l = (u ? "client" : "offset") + (f ? "Width" : "Height"),
      _ = 100,
      c = r === "px",
      d = r === "%",
      p,
    ...
    if (
      ...
      return (
        (p = y ? t.getBBox()[f ? "width" : "height"] : t[l]),
        I(d ? (n / p) * _ : (n / 100) * p)
      );
    if (
      ((a[f ? "width" : "height"] = _ + (c ? s : r)),
      (h =
        ~e.indexOf("adius") || (r === "em" && t.appendChild && !u)
          ? t
          : t.parentNode),
      y && (h = (t.ownerSVGElement || {}).parentNode),
      (!h || h === wt || !h.appendChild) && (h = wt.body),
      (g = h._gsap),
      g && d && g.width && f && g.time === et.time && !g.uncache)
    )
      return I((n / g.width) * _);
    if (d && (e === "height" || e === "width")) {
      var x = t.style[e];
      (t.style[e] = _ + r), (p = t[l]), x ? (t.style[e] = x) : Yt(t, e);
    } else
      (d || s === "%") &&
        !Gn[pt(h, "display")] &&
        ...
        (a.position = "absolute");
    return (
      f && d && ((g = Bt(h)), (g.time = et.time), (g.width = h[l])),
      I(c ? (p * n) / _ : p && n ? (_ / p) * n : 0)
    );
  },
  xt = function (t, e, i, r) {
    var n;
  ...
  $n = function (t, e, i, r) {
    ...
    var a = new Z(this._pt, t.style, e, 0, 1, Tr),
      f = 0,
      u = 0,
      l,
      _,
      ...
      for (; (_ = qt.exec(r)); )
        (g = _[0]),
          ...
          g !== (h = c[u++] || "") &&
            ((d = parseFloat(h) || 0),
            (T = h.substr((d + "").length)),
            g.charAt(1) === "=" && (g = Gt(d, g) + T),
            (y = parseFloat(g)),
            (v = g.substr((y + "").length)),
            (f = qt.lastIndex - v.length),
            v ||
              ((v = v || rt.units[e] || T),
              f === r.length && ((r += v), (a.e += v))),
            T !== v && (d = kt(t, e, h, v) || 0),
            (a._pt = {
              _next: a._pt,
              p: x || u === 1 ? x : ",",
    ...
    if (e.tween && e.tween._time === e.tween._dur) {
      ...
      if (n === "all" || n === !0) (r.cssText = ""), (f = 1);
        ...
        for (n = n.split(","), u = n.length; --u > -1; )
          (a = n[u]),
            Tt[a] && ((f = 1), (a = a === "transformOrigin" ? j : B)),
            Yt(i, a);
      f &&
        (Yt(i, B),
        s &&
  ...
  zi = function (t) {
    var e = pt(t, B);
    return Ar(e) ? ce : e.substr(7).match(Ni).map(I);
  },
  yi = function (t, e) {
    var i = t._gsap || Bt(t),
      r = t.style,
    ...
    return i.svg && t.getAttribute("transform")
      ...
      : (n === ce &&
          ...
          (s = t.parentNode),
          (!s || !t.offsetParent) &&
            ((u = 1), (a = t.nextElementSibling), $t.appendChild(t)),
          (n = zi(t)),
          f ? (r.display = f) : Yt(t, "display"),
          u &&
            (a
              ? s.insertBefore(t, a)
              : s
  ...
  ei = function (t, e, i, r, n, s) {
    ...
    i
      ? f !== ce &&
        (P = d * g - p * h) &&
        ((S = T * (g / P) + m * (-h / P) + (h * x - g * y) / P),
        (b = T * (-p / P) + m * (d / P) - (d * x - p * y) / P),
        (T = S),
        (m = b))
      : ((w = Mr(t)),
        (T = w.x + (~v[0].indexOf("%") ? (T / 100) * w.width : T)),
        (m = w.y + (~(v[1] || v[0]).indexOf("%") ? (m / 100) * w.height : m))),
      r || (r !== !1 && a.smooth)
        ? ((y = T - u),
          (x = m - l),
          (a.xOffset = _ + (y * d + x * h) - y),
          (a.yOffset = c + (y * p + x * g) - x))
      ...
      s &&
        (Pt(s, a, "xOrigin", u, T),
        Pt(s, a, "yOrigin", l, m),
        Pt(s, a, "xOffset", _, a.xOffset),
        Pt(s, a, "yOffset", c, a.yOffset)),
  ...
  de = function (t, e) {
    ...
    return (
      ...
      i.svg &&
        (i.uncache
          ? ((lt = t.getBBox()),
            (u = i.xOrigin - lt.x + "px " + (i.yOrigin - lt.y) + "px"),
            (Y = ""))
          : (Y = !e && t.getAttribute("data-svg-origin")),
        ei(t, Y || u, !!Y || i.originIsAbsolute, i.smooth !== !1, P)),
      (m = i.xOrigin || 0),
      (w = i.yOrigin || 0),
      P !== ce &&
        ((E = P[0]),
        ...
        P.length === 6
          ? ((d = Math.sqrt(E * E + R * R)),
            ...
            (h = E || R ? Xt(R, E) * zt : 0),
            (x = D || q ? Xt(D, q) * zt + h : 0),
            x && (p *= Math.abs(Math.cos(x * Ht))),
            i.svg && ((l -= m - (m * E + w * D)), (_ -= w - (m * R + w * q))))
          : ((Dt = P[6]),
            (xi = P[7]),
            (te = P[8]),
            (ee = P[9]),
            ...
            g &&
              ...
              ((g = h = 0), (y = 180 - y)),
            (d = I(Math.sqrt(E * E + R * R + D * D))),
            (p = I(Math.sqrt(N * N + Dt * Dt))),
            (S = Xt(V, N)),
            (x = Math.abs(S) > 2e-4 ? S * zt : 0),
            (T = mt ? 1 / (mt < 0 ? -mt : mt) : 0)),
        i.svg &&
          ((Y = t.getAttribute("transform")),
          (i.forceCSS = t.setAttribute("transform", "") || !Ar(pt(t, B))),
          Y && t.setAttribute("transform", Y))),
      Math.abs(x) > 90 &&
        Math.abs(x) < 270 &&
        (n
          ? ((d *= -1), (x += h <= 0 ? 180 : -180), (h += h <= 0 ? 180 : -180))
          : ((p *= -1), (x += x <= 0 ? 180 : -180))),
      (e = e || i.uncache),
      (i.x =
        l -
      ...
      (i.renderTransform = i.svg ? Zn : kr ? Er : Qn),
      (i.uncache = 0),
      i
    );
  },
  ...
  Er = function (t, e) {
    ...
    if (v && (_ !== At || l !== At)) {
      ...
      (w = parseFloat(_) * Ht),
        (b = Math.cos(w)),
        (s = Ve(x, s, P * b * -v)),
        (a = Ve(x, a, -Math.sin(w) * -v)),
        (f = Ve(x, f, S * b * -v + v));
    }
    g !== ie && (T += "perspective(" + g + Et),
      (r || n) && (T += "translate(" + r + "%, " + n + "%) "),
      (m || s !== ie || a !== ie || f !== ie) &&
        (T +=
          f !== ie || m
      ...
      l !== At && (T += "rotateY(" + l + Et),
      _ !== At && (T += "rotateX(" + _ + Et),
      (c !== At || d !== At) && (T += "skew(" + c + ", " + d + Et),
      (p !== 1 || h !== 1) && (T += "scale(" + p + ", " + h + Et),
      (x.style[B] = T || "translate(0, 0)");
  },
  Zn = function (t, e) {
    var i = e || this,
      r = i.xPercent,
  ...
  jn = function (t, e, i, r, n) {
    var s = 360,
      a = X(n),
      f = parseFloat(n) * (a && ~n.indexOf("rad") ? zt : 1),
      u = f - r,
      l = r + u + "deg",
      _,
      c;
    return (
      a &&
        ...
        _ === "cw" && u < 0
          ? (u = ((u + s * Mi) % s) - ~~(u / s) * s)
          : _ === "ccw" && u > 0 && (u = ((u - s * Mi) % s) - ~~(u / s) * s)),
      (t._pt = c = new Z(t._pt, e, i, r, u, Fn)),
      (c.e = l),
      (c.u = "deg"),
      t._props.push(i),
      c
  ...
  Jn = function (t, e, i) {
    ...
    r.svg
      ...
      : ((u = getComputedStyle(i)[B]), (s[B] = e), (a = de(i, 1)), (s[B] = u));
    for (f in Tt)
      (u = r[f]),
        (l = a[f]),
        u !== l &&
          ...
          ((d = W(u)),
          (p = W(l)),
          (_ = d !== p ? kt(i, f, u, p) : parseFloat(u)),
          (c = parseFloat(l)),
          (t._pt = new Z(t._pt, a, f, _, c - _, je)),
          (t._pt.u = p || 0),
          t._props.push(f));
    Fi(a, r);
  };
Q("padding,margin,Width,Radius", function (o, t) {
  ...
  Ce[t > 1 ? "border" + o : o] = function (a, f, u, l, _) {
    var c, d;
...
var zr = {
  ...
  init: function (t, e, i, r, n) {
    ...
    pi || ti(),
      ...
      (this.tween = i);
    for (h in e)
      if (h !== "autoRound" && ((l = e[h]), !(tt[h] && gr(h, e, i, r, t, n)))) {
        if (
          ((d = typeof l),
          (p = Ce[h]),
          d === "function" && ((l = l.call(i, r, t, n)), (d = typeof l)),
          d === "string" && ~l.indexOf("random(") && (l = le(l)),
          p)
        )
          p(this, t, h, l, i) && (P = 1);
          ...
          (u = (getComputedStyle(t).getPropertyValue(h) + "").trim()),
            (l += ""),
            (Ot.lastIndex = 0),
            Ot.test(u) || ((g = W(u)), (y = W(l))),
            y ? g !== y && (u = kt(t, h, u, y) + y) : g && (l += g),
            this.add(a, "setProperty", u, l, r, n, 0, 0, h),
            s.push(h),
            S.push(h, 0, a[h]);
        else if (d !== "undefined") {
          if (
            (f && h in f
              ? ((u = typeof f[h] == "function" ? f[h].call(i, r, t, n) : f[h]),
                X(u) && ~u.indexOf("random(") && (u = le(u)),
                W(u + "") ||
                  u === "auto" ||
                  (u += rt.units[h] || W(xt(t, h)) || ""),
                (u + "").charAt(1) === "=" && (u = xt(t, h)))
              : (u = xt(t, h)),
            (c = parseFloat(u)),
            ...
            h in dt &&
              (h === "autoAlpha" &&
                (c === 1 && xt(t, "visibility") === "hidden" && _ && (c = 0),
            ...
            if (
              ...
              T ||
                ...
                (w = e.smoothOrigin !== !1 && m.smooth),
                (T = this._pt =
                  new Z(this._pt, a, B, 0, 1, m.renderTransform, m, 0, -1)),
                (T.dep = 1)),
              h === "scale")
            )
              (this._pt = new Z(
                ...
                "scaleY",
                m.scaleY,
                (x ? Gt(m.scaleY, x + _) : _) - m.scaleY || 0,
                je
              )),
                (this._pt.u = 0),
                s.push("scaleY", h),
              ...
              S.push(j, 0, a[j]),
                ...
                m.svg
                  ...
                  : ((y = parseFloat(l.split(" ")[2]) || 0),
                    y !== m.zOrigin && Pt(this, m, "zOrigin", m.zOrigin, y),
                    Pt(this, a, h, ke(u), ke(l)));
              continue;
            } else if (h === "svgOrigin") {
              ei(t, l, 1, w, 0, this);
              continue;
            } else if (h in Dr) {
              jn(this, m, h, c, x ? Gt(c, x + l) : l);
              continue;
            } else if (h === "smoothOrigin") {
              Pt(this, m, "smooth", m.smooth, l);
              continue;
            } else if (h === "force3D") {
              m[h] = l;
              continue;
          ...
          if (v || ((_ || _ === 0) && (c || c === 0) && !zn.test(l) && h in a))
            (g = (u + "").substr((c + "").length)),
              _ || (_ = 0),
              (y = W(l) || (h in rt.units ? rt.units[h] : g)),
              g !== y && (c = kt(t, h, u, y)),
              (this._pt = new Z(
                this._pt,
                v ? m : a,
                ...
                c,
                (x ? Gt(c, x + _) : _) - c,
                !v && (y === "px" || h === "zIndex") && e.autoRound !== !1
                  ? Ln
                  : je
              )),
              (this._pt.u = y || 0),
              g !== y && y !== "%" && ((this._pt.b = u), (this._pt.r = Bn));
          else if (h in a) $n.call(this, t, h, u, x ? x + l : l);
          else if (h in t) this.add(t, h, u || t[h], x ? x + l : l, r, n);
          else if (h !== "parseTransform") {
            ai(h, l);
            continue;
          }
          v || (h in a ? S.push(h, 0, a[h]) : S.push(h, 1, u || t[h])),
            s.push(h);
        }
      }
    P && br(this);
  ...
  core: { _removeProperty: Yt, _getMatrix: yi },
};
...
J.registerPlugin(zr);
var ts = J.registerPlugin(zr) || J;
ts.core.Tween;
const es = (o, t, e) => {
    const i = { cursor: t.parallaxIndex, target: t.parallaxIndex * 1.5 };
    let r = !1,
      n = null;
    const s = (u) => {
        if (!r)
          k.to(o, t.transitionSpeed, {
            x: u.clientX - t.radius / 2,
            y: u.clientY - t.radius / 2,
          });
        else {
          const l = Number(
            window.getComputedStyle(n).borderRadius.slice(0, -2)
          );
          ht(n, st.lift)
            ? (k.to(n, t.transitionSpeed, {
                x: me(
                  u.clientX,
              ...
              k.to(o, t.transitionSpeed, {
                ...
                y:
                  ...
                  (u.clientY -
                    ...
                    n.clientHeight / 2) /
                    i.cursor,
                backgroundImage: `radial-gradient(circle at ${u.clientX - n.getBoundingClientRect().left}px ${u.clientY - n.getBoundingClientRect().top}px, rgba(255,255,255,0.4), rgba(255,255,255,0))`,
              }))
            : (k.to(o, t.transitionSpeed, {
                x:
                  n.getBoundingClientRect().left -
                  (ht(n, st.noPadding) ? null : t.hoverPadding) +
                  (ht(n, st.noParallax)
                    ? 0
                    : (u.clientX -
                        n.getBoundingClientRect().left -
                ...
                y:
                  ...
                  (ht(n, st.noParallax)
                    ...
                    : (u.clientY -
                        ...
                        n.clientHeight / 2) /
                      i.cursor),
                borderRadius: l * (ht(n, st.noPadding) ? 1 : 1.5),
                width:
                  n.clientWidth +
                  (ht(n, st.noPadding) ? null : t.hoverPadding * 2),
                height:
                  n.clientHeight +
                  (ht(n, st.noPadding) ? null : t.hoverPadding * 2),
              }),
      ...
      a = (u) => {
        (r = !0), (n = u.target);
        const l = Number(window.getComputedStyle(n).borderRadius.slice(0, -2));
        ht(n, st.lift)
          ? (o.classList.add("c-cursor-lift_active"),
            k.to(o, t.transitionSpeed, {
              borderRadius: l,
              width: n.clientWidth,
          ...
          : o.classList.add("c-cursor_active");
      },
      f = (u) => {
        (r = !1),
          o.classList.remove("c-cursor_active"),
          o.classList.remove("c-cursor-lift_active"),
          k.to(o, t.transitionSpeed, {
            x: u.clientX - t.radius / 2,
            y: u.clientY - t.radius / 2,
            width: t.radius,
    ...
    document.addEventListener("mousewheel", (u) => {
      f(u);
    }),
  ...
  is = (o = {}) => {
    (o = {
      radius: o.radius || 20,
      transitionSpeed: o.transitionSpeed || 0.2,
      parallaxIndex: o.parallaxIndex || 10,
      hoverPadding: o.hoverPadding || 6,
    }),
      Lr();
    const t = Fr(o);
    window.onload = () => {
      let e = document.querySelectorAll(`[${st.dataAttr}]`);
      es(t, o, e);
    };
  };
is({ radius: 20 });
