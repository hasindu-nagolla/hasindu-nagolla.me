...
export default function Projects() {
 ...
 <a href="#" className="px-7 py-3.5 rounded-xl bg-brand-dark text-white font-bold text-sm hover:opacity-90 transition-opacity flex items-center gap-2 shadow-lg shadow-brand-dark/20">
 Live Project
 ...
 <div className="flex items-center gap-6">
 <a href="https://hasiimusic.hasindunagolla.live/" target="_blank" rel="noreferrer" className="px-7 py-3.5 rounded-xl bg-brand-dark text-white font-bold text-sm hover:opacity-90 transition-opacity flex items-center gap-2 shadow-lg shadow-brand-dark/20">
 Live Bot
 <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
 </a>
