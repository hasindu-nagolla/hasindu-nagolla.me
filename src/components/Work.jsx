    ...
    const work = [
        {
            ...
            tech: ['Python', 'Pyrogram', 'MongoDB', 'yt-dlp', 'FFmpeg', 'Linux', 'Docker', 'Cloud Environments'],
...

        {
            ...
            description: 'MindBou is a modern, premium blogging and publishing platform designed to connect writers and readers through a distraction-free, high-quality reading experience.',
            tech: ['TypeScript', 'React.js', 'Tailwind CSS', 'Express.js', 'Node.js', 'MongoDB', 'Vercel', 'Render',],
...

        {
            ...
            category: 'AI / ML',
            description: 'A document-based RAG system using DeepSeek to answer questions from PDF documents.',
        ...
        },
        {
            ...
            category: 'AI / ML',
            description: 'Real-time NLP based scam detection model for low context languages using Python.',
        ...
        },
        {
            ...
            category: 'Web Application',
            description: 'web application designed to revolutionize the way you schedule medical appointments.',
            tech: ['JavaScript', 'EJS', 'Boostrap', 'Node.js', 'Express.js', 'MongoDB'],
