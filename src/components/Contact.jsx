            ...
            <div className="max-w-7xl mx-auto z-10 relative">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
                    ...
                    <div className="animate-on-scroll is-visible">
                        <p className="text-brand-primary font-bold text-sm tracking-wider uppercase mb-2">Get in touch</p>
                        <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-brand-dark mb-6">Let's Work Together</h2>

                        <p className="text-lg text-gray-500 mb-10 leading-relaxed">
                            Have a project in mind or want to collaborate?<br className="hidden sm:block" />
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-brand-dark mb-0.5">Email</h4>
                                    <p className="text-sm text-gray-500">hasindu.connect@proton.me</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-brand-dark mb-0.5">Location</h4>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="text-sm font-bold text-brand-dark mb-0.5">Response Time</h4>
                    ...
                    <div className="animate-on-scroll is-visible" style={{ animationDelay: '0.2s' }}>
                        <form onSubmit={onSubmit} className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm flex flex-col gap-5">
                            ...
                            {result && <p className="text-center text-sm font-medium text-brand-primary mt-2">{result}</p>}
                        </form>
                    </div>
